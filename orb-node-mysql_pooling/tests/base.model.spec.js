var Model = require("../models/BaseModel"), dbMockup = {};
...
describe("Models", function() {
	it("should create a new model", function(next) {
		...
		should.exist(model.db);
		should.exist(model.extend);
		next();
	});
	it("should be extendable", function(next) {
		...
		should.exist(model2.db);
		should.exist(model2.myCustomModelMethod);
		next();
	})
